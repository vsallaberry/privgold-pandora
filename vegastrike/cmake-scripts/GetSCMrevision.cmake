...
# Usage:
#    ${CMAKE_COMMAND} -DGETSCM_SOURCE_DIR="<root-source-folder>" -DGETSCM_VERSION_FILE="<output-version-file>" -P GetSCMrevision.cmake
# Example:
...
file(WRITE "${GETSCM_VERSION_FILE}.txt" "#ifndef _CMAKE_GETSCM_VERSION_H\n# define _CMAKE_GETSCM_VERSION_H\n"
     "# define SCM_VERSION \"${_SCM_REV_EXEC_STRING}\"\n"

...
*/
posh_s16_t *
POSH_WriteS16ToLittle( void *dst, posh_s16_t value )
{
...
*/
posh_s32_t *
POSH_WriteS32ToLittle( void *dst, posh_s32_t value )
{
...
*/
posh_s16_t *
POSH_WriteS16ToBig( void *dst, posh_s16_t value )
{
...
*/
posh_s32_t *
POSH_WriteS32ToBig( void *dst, posh_s32_t value )
{
...
*/
posh_s64_t *
POSH_WriteS64ToLittle( void *dst, posh_s64_t value )
{
...
*/
posh_s64_t *
POSH_WriteS64ToBig( void *dst, posh_s64_t value )
{
...
*/
posh_s16_t  
POSH_ReadS16FromLittle( const void *src )
{
...
*/
posh_s32_t  
POSH_ReadS32FromLittle( const void *src )
{
...
*/
posh_s16_t  
POSH_ReadS16FromBig( const void *src )
{
...
*/
posh_s32_t  
POSH_ReadS32FromBig( const void *src )
{
...
*/
posh_s64_t  
POSH_ReadS64FromLittle( const void *src )
{
...
*/
posh_s64_t
POSH_ReadS64FromBig( const void *src )
{

...
EXPORT_UTIL(queryTimeofday,10003)
EXPORT_UTIL(exp,1)
EXPORT_UTIL(acos,1)
EXPORT_UTIL(asin,1)
EXPORT_UTIL(atan,1)
...
EXPORT_UTIL(loadGame,false)
EXPORT_UTIL(saveGame,false)
...
voidEXPORT_UTIL(enableKeyRepeat)
EXPORT_UTIL(restoreKeyRepeat,false)

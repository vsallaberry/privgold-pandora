...
PFNGLMAPBUFFERARBPROC  glMapBufferARB_p=NULL;
PFNGLUNMAPBUFFERARBPROC  glUnmapBufferARB_p=NULL;

PFNGLCLIENTACTIVETEXTUREARBPROC glClientActiveTextureARB_p=NULL;
PFNGLCLIENTACTIVETEXTUREARBPROC glActiveTextureARB_p=NULL;
PFNGLCOLORTABLEEXTPROC glColorTable_p=NULL;
PFNGLMULTITEXCOORD2FARBPROC glMultiTexCoord2fARB_p = NULL;
PFNGLMULTITEXCOORD4FARBPROC glMultiTexCoord4fARB_p = NULL;

PFNGLLOCKARRAYSEXTPROC glLockArraysEXT_p = NULL;
PFNGLUNLOCKARRAYSEXTPROC glUnlockArraysEXT_p = NULL;
PFNGLCOMPRESSEDTEXIMAGE2DPROC glCompressedTexImage2D_p = NULL;
PFNGLMULTIDRAWARRAYSEXTPROC glMultiDrawArrays_p = NULL;
PFNGLMULTIDRAWELEMENTSEXTPROC glMultiDrawElements_p = NULL;

 PFNGLGETSHADERIVPROC glGetShaderiv_p=NULL;
 PFNGLGETPROGRAMIVPROC glGetProgramiv_p=NULL;
 PFNGLGETSHADERINFOLOGPROC glGetShaderInfoLog_p = NULL;
 PFNGLGETPROGRAMINFOLOGPROC glGetProgramInfoLog_p = NULL;
 PFNGLCREATESHADERPROC glCreateShader_p = NULL;
 PFNGLSHADERSOURCEPROC glShaderSource_p = NULL;
 PFNGLCOMPILESHADERPROC glCompileShader_p = NULL;
 PFNGLCREATEPROGRAMPROC glCreateProgram_p = NULL;
 PFNGLATTACHSHADERPROC glAttachShader_p = NULL;
 PFNGLLINKPROGRAMPROC glLinkProgram_p = NULL;
 PFNGLUSEPROGRAMPROC glUseProgram_p = NULL;
 PFNGLGETUNIFORMLOCATIONPROC glGetUniformLocation_p = NULL;
 PFNGLUNIFORM1FPROC glUniform1f_p = NULL;
 PFNGLUNIFORM2FPROC glUniform2f_p = NULL;
 PFNGLUNIFORM3FPROC glUniform3f_p = NULL;
 PFNGLUNIFORM4FPROC glUniform4f_p = NULL;

 PFNGLUNIFORM1IPROC glUniform1i_p = NULL;
 PFNGLUNIFORM2IPROC glUniform2i_p = NULL;
 PFNGLUNIFORM3IPROC glUniform3i_p = NULL;
 PFNGLUNIFORM4IPROC glUniform4i_p = NULL;

 PFNGLUNIFORM1FVPROC glUniform1fv_p = NULL;
 PFNGLUNIFORM2FVPROC glUniform2fv_p = NULL;
 PFNGLUNIFORM3FVPROC glUniform3fv_p = NULL;
 PFNGLUNIFORM4FVPROC glUniform4fv_p = NULL;

 PFNGLUNIFORM1IVPROC glUniform1iv_p = NULL;
 PFNGLUNIFORM2IVPROC glUniform2iv_p = NULL;
 PFNGLUNIFORM3IVPROC glUniform3iv_p = NULL;
 PFNGLUNIFORM4IVPROC glUniform4iv_p = NULL;

 PFNGLDELETESHADERPROC glDeleteShader_p = NULL;
 PFNGLDELETEPROGRAMPROC glDeleteProgram_p = NULL;
...
(void) VS_LOG("gl", logvs::NOTICE, "OpenGL Extensions supported: %s", extensions);
    ...
    if (vsExtensionSupported( "GL_EXT_multi_draw_arrays")) {
        ...
        glMultiDrawArrays_p = NULL;
        glMultiDrawElements_p = NULL;
